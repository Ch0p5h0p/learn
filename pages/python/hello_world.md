...
Python is simple, so really all we have to do is tell it to print the words to the console and it'll do it, no setup.

```python
print("Hello, World!")
```

Simple enough, huh? Generally, in your IDE (or terminal) you'll see `Hello, World!` printed out. Maybe it'll have some form of prefix, but it should print out that text.
